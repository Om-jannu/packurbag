...
//       Uri.parse('http://192.168.0.115:5000/get_todos'),
...
//             todos = List<TodoItem>.from(
//               data['todos'].map((todo) => TodoItem(text: todo, isChecked: false)),
//             );
//           });
//         } else {
...
//       Uri.parse('http://192.168.0.115:5000/edit_todo'),
//       headers: {'Content-Type': 'application/json'},
//       body: jsonEncode({
//         'username': username,
//         'category': widget.category,
...
//       Uri.parse('http://192.168.0.115:5000/delete_todo'),
//       headers: {'Content-Type': 'application/json'},
//       body: jsonEncode({
//         'username': username,
//         'category': widget.category,
...
//     return Scaffold(
//       appBar: AppBar(
//         title: Text('${widget.category} Todo List'),
//       ),
//       body: Column(
//         children: [
//           Expanded(
